...
SerialComNode::SerialComNode(std::string module_name)
  ...
  CHECK(rrts::common::ReadProtoFromTextFile("/home/artinx-minipc-2/RoboRTS_last/modules/driver/serial/config/serial_com_config.prototxt",
                                            &serial_port_config))
...
void SerialComNode::Run() {
  ...
  sub_cmd_gim_ = nh_.subscribe("detector", 1, &SerialComNode::GimbalControlCallback, this);
